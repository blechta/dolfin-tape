...
This is modified version, originally from FFC, which hooks to
disk-free caching.

FIXME: It would be better to make a space for injecting hooks into
FFC thus avoinding a need to fetch changes in <ffc>/ffc/jitcompiler.py
to stay compatible with FFC master.
"""

# Copyright (C) 2007-2015 Anders Logg, 2016 Jan Blechta
#
# This file is originally part of FFC.
...
# Disk-Free Caching, Dolfin-tape Form-Compiler-frontend
from dolfintape.dfc.cache import load as dfc_load, store as dfc_store
...
def jit_form(form, parameters=None):
    ...
    # Change compiler name to ffc to generate same signatures
    assert parameters["name"] == "dolfintape"
    parameters["name"] = "ffc"
    ...
    # Offer the result to cache and return
